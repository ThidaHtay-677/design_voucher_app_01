...
const Pagination = ({
  ...
  const handleRowLimitSelect = (e) => {
    setParams({ page: 1, limit: e.target.value });// first page whenever the user selects a new limit
    //	Updates the URL
    updateFetchUrl(`${path}?page=1&limit=${e.target.value}`);//Updates the data-fetching logic
  };
